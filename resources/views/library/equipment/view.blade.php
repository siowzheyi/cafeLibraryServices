        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">View Library Equipment</h1>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <h4>Library Equipment Detail</h4>
                            <table width="100%" href="{{ route('Equipment.show') }}">
                                <tr>
                                    <td>Picture</td>
                                    <td>:</td>
                                    <td><img src="{{ asset('images/eqpmnt.jpg') }}" width="200"></td>
                                </tr>
                                <tr>
                                    <td width="15%">Equipment Name</td>
                                    <td width="5%">:</td>
                                    <td width="80%">Controller PS5</td>
                                </tr>
                                <tr>
                                    <td>Quantity</td>
                                    <td>:</td>
