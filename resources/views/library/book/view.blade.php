            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">View Library Book</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <h4>Library Book Detail</h4>
                                <table width="100%" href="{{ route('Book.show') }}">
                                    <tr>
                                        <td>Picture</td>
                                        <td>:</td>
                                        <td><img src="images/book1.jpg" width="200"></td>
                                    </tr>
                                    <tr>
                                        <td width="15%">Book Name</td>
                                        <td width="5%">:</td>
                                        <td width="80%">puteri Gunung Ledang</td>
                                    </tr>
                                    <tr>
                                        <td>Genre</td>
                                        <td>:</td>
