            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                       data-bs-target="#collapseLayoutsLib" aria-expanded="false" aria-controls="collapseLayoutsLib">
                        <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                        Library
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
                    <div class="collapse bgsubmenu" id="collapseLayoutsLib" aria-labelledby="headingOne"
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">View Library Room</h1>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <h4>Library Room Detail</h4>
                        <table width="100%">
                            <tr>
                                <td>Picture</td>
                                <td>:</td>
                                <td><img src="{{ asset('images/meeting1.jpg') }}" width="200"></td>
                            </tr>
                            <tr>
                                <td width="15%">Room No.</td>
                                <td width="5%">:</td>
                                <td width="80%">R2001</td>
                            </tr>
                            <tr>
                                <td>Room Type</td>
                                <td>:</td>
