            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark bgsidebar" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active" href="{{ route('cafe.index') }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                            Cafe
                        </a>
                    </div>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Edit Cafe Table</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('table.index') }}">Cafe</a></li>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <form action="{{ route('cafe.update',['cafe' => $data['id']]) }}" method="POST">
                                @method('PUT')
                                @csrf
                                <div class="form-group mb-2">
                                    <label for="exampleFormControlInput1">Cafe Name</label>
