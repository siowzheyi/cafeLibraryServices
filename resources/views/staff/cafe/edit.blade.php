        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Edit Cafe Staff</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="staff-cafe-page.html">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('User.index') }}">Cafe Staff</a></li>
                        <li class="breadcrumb-item active">Edit</li>
                    </ol>
                    <div class="row mb-4">
                        <div class="col-12">
                            <form href="{{ route('User.update') }}">
                                <div class="form-group mb-2">
                                    <label for="exampleFormControlInput1">Name</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" value="Aura Aisya">
                                </div>
                                <div class="form-group mb-2">
                                    <label for="exampleFormControlInput1">Library ID</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" value="L123">
                                </div>
