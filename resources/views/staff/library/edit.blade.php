        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Edit Library Staff</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="staff-library-page.html">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('User.index') }}">Library Staff</a></li>
                        ...
                        <div class="col-12">
                            <form href="{{ route('User.update') }}">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1" value="Mohamad Hasan">
                                </div>
                                <div class="form-group mb-2">
                                    <label for="exampleFormControlInput1">Address</label>
                                    <textarea class="form-control" id="exampleFormControlInput1">Lot 123, Puchong Intan, Selangor</textarea>
                                </div> 
