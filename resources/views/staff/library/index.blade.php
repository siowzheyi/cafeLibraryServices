        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Library Staff</h1>
                    ...
                    <div class="row mb-2">
                        <div class="col-12">
                            <a href="{{ route('User.store') }}" class="btn btn-success float-end"><i class="fa fa-plus"></i> Create New Library Staff</a>
                        </div>
                    </div>
                    <div class="card mb-4">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Mohamad Hasan</td>
                                        <td>Lot 123, Puchong Intan, Selangor</td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{ route('User.show') }}" class="btn btn-sm btn-info"><i class="fa fa-eye"></i> View</a>
                                            <a href="{{ route('User.update') }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</a>
