...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark bgtopbar">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="{{ route('index') }}">CAFÉ LIBRARY</a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Create New Library Staff</h1>
                        ...
                        <div class="col-12">
                            <form href="{{ route('User.store') }}">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlInput1" value=""></textarea>
                                </div>
