        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">View Library Staff</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="staff-library-page">Dashboard</a></li>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <h4>Staff Detail</h4>
                            <table width="100%" href="{{ route('User.show') }}">
                                <tr>
                                    <td width="15%">Name</td>
                                    <td width="5%">:</td>
                                    <td width="80%">Mohamad Hasan</td>
                                </tr>
                                <tr>
                                    <td>Address</td>
                                    <td>:</td>
